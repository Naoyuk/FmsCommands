...
echo "\n\e[1;34m*****FileMaker Serverアドミンコンソール Mac版*****\e[1;37m\n"
...
# ログインチェック
fmsadmin -v -u ${ID} -p ${PW} || { echo "\e[1;31mIDとパスワードが違います。もっかいやり直してください。\e[1;37m"; exit 1; }
...
echo '======================================================================'
for((i=0; i<${#SELECT[*]}; i++ )){
  echo "\e[1;34m$i: ${SELECT[i]}\e[1;37m"
}
echo '======================================================================'
echo "\n処理を選択してください..."
